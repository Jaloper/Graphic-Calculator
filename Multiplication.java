...
public class Multiplication extends BinExpression{
    ...
    public Expression replace(String var, int n) {
        return new Multiplication(e1.replace(var, n), e2.replace(var, n));
    }

    @Override
    public Expression rename(String v1, String v2) {
        return new Multiplication(e1.rename(v1, v2), e2.rename(v2, v1));
    }

    @Override
    public Expression copy() {
        return new Multiplication(e1.copy(), e2.copy());
    }
